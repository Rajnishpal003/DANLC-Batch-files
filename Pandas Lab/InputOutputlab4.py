...
#drop rows where specific columns have misisng values
df1=df.dropna(subset=['ord_no','purch_amt'])
print("Drop those rows in which specific columns have missing values:\n",df1)
